...
$u(s)$ | Функція збурень
$n$ | Розмірність просторової області $S_0$
$\Gamma$ | Контур (точки) просторової $S_0$
$T$ | Правий кінець часового інтервалу $S_0$
$y(s)$ | Досліджуєма функція стану
$S^0$ | Проміжок можливих значень датчика
...
\begin{equation}
\begin{aligned}
y_{\infty} (s) &= \int_{S_0^T} G(s - s') u(s') \  ds' \\\\
